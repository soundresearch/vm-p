...
export function Model({ setMessage, resetPos, setResetPos, setAnimationComplete, selectedButton, setSelectedButton, setCursorStyle, ...props }) {
  ...
  // Function to reset the positions of the emojis after they fall
